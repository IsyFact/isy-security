...
Weitere Informationen und detaillierte Anleitungen zur Verwendung können im Abschnitt zum xref:nutzungsvorgaben/master.adoc#authentifizierungsmanager-interface[Authentifizierungsmanager] gefunden werden.
...
* bzw. xref:task::nutzungsvorgaben.adoc#absicherung-von-tasks[Absicherung von Tasks]
