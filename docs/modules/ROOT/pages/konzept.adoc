...
Außerdem sichert der Baustein `isy-security` die Services der IsyFact-Anwendungen ab, indem er Funktionalität zur Berechtigungsprüfung anbietet. Hier wird geprüft, ob die gewährte Autorisierung auch das Recht zur Nutzung des angefragten Services beinhaltet.
